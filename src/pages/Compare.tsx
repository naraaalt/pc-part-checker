                ...
                <table className="compare-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Case Fans</td>
                      <td>
                        {build1.build.caseFan
                          ? `${build1.build.caseFan.count} × ${build1.build.caseFan.name}`
                          : "--"}
                      </td>
                      <td>
                        {build2.build.caseFan
                          ? `${build2.build.caseFan.count} × ${build2.build.caseFan.name}`
                          : "--"}
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr className="highlight-row">
                      ...
                      <td>
                        ...
                        <span className="delta">
                          {" "}
                          (
                          {calculatePower(build2.build) >=
                          calculatePower(build1.build)
                            ? "+"
                            : ""}
                          {calculatePower(build2.build) -
                            calculatePower(build1.build)}
                    ...
                    <tr className="highlight-row">
                      ...
                      <td>
                        ...
                        <span className="delta">
                          {" "}
                          (
                          {calculatePrice(build2.build) >=
                          calculatePrice(build1.build)
                            ? "+"
                            : ""}
                          {formatPrice(
                            calculatePrice(build2.build) -
